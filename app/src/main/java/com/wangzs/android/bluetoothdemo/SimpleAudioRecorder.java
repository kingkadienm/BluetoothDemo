...
import com.wangzs.android.bluetoothdemo.exception.SimpleAudioException;
...
//        if (!isHasFocus) return;
        ...
        try {
            final File file = new File(SimpleAudioManager.getApplication().getExternalCacheDir() ,"auto_1111.m4a");
            // 文件的空判断
